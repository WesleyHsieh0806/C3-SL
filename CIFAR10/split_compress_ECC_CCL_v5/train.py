...
from utils import BT_Loss, BT_2matrix_Loss
...
parser.add_argument("--Lambda2", required=False, type=float,
                    default=0.0001, help="The Lambda for the second BT loss term")
parser.add_argument("--beta", required=False, type=float,
                    default=0.0001, help="The beta for off-diagonal terms")
parser.add_argument("--beta2", required=False, type=float,
                    default=0.0001, help="The beta for off-diagonal terms of the second BT loss term")
