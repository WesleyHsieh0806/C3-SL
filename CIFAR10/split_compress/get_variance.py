...
* Corresponding experiments: Get the variance for each dimension
'''
...
if not os.path.isdir(os.path.join(
        os.path.dirname(__file__), "Variance")):
...
np.save(os.path.join(
        os.path.dirname(__file__), "Variance", 'labels_Batch{}.npy'.format(args.batch)), labels)
np.save(os.path.join(
        os.path.dirname(__file__), "Variance", 'features_Batch{}.npy'.format(args.batch)), features)
np.save(os.path.join(
        os.path.dirname(__file__), "Variance", 'gradients_Batch{}.npy'.format(args.batch)), gradients)
